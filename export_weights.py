...
def export_to_binary(pkl_path="ai/weights.pkl", bin_path="build/bin/tuple_weights.bin"):
    ...
    with open(bin_path, "wb") as f:
        # Write the number of elements (65536) at the beginning of the file for C++ to verify
        # C++ expects: [uint32 count] [float row_weights...] [float square_weights...]
