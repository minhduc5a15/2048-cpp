...
namespace tfe::renderer {
    ...
    const char* ConsoleRenderer::getColor(int value) {
        switch (value) {
            ...
            case 4:
                return "\033[48;5;229m\033[38;5;0m";  // Light Yellow
            case 8:
                return "\033[48;5;208m\033[38;5;255m";  // Orange
            case 16:
                return "\033[48;5;196m\033[38;5;255m";  // Red
            case 32:
                return "\033[48;5;160m\033[38;5;255m";  // Dark Red
            case 64:
                return "\033[48;5;199m\033[38;5;255m";  // Pink
            case 128:
                return "\033[48;5;123m\033[38;5;0m";  // Cyan
            case 256:
                return "\033[48;5;46m\033[38;5;0m";  // Green
            case 512:
                return "\033[48;5;27m\033[38;5;255m";  // Blue
            case 1024:
                return "\033[48;5;226m\033[38;5;0m";  // Yellow
            case 2048:
                return "\033[48;5;220m\033[38;5;0m";  // Gold
            default:
                return "\033[48;5;237m\033[38;5;255m";  // Dark Grey (Empty)
        }
    }
