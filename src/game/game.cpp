    ...
    void Game::run() {
        while (isRunning_) {
            ...
            if (board_.isGameOver()) {
                ...
                // Chờ người dùng nhấn phím bất kỳ để thoát hoặc xử lý logic restart (tạm thời thoát)
            ...
            // Nếu người dùng bấm phím không hợp lệ hoặc di chuyển không tạo ra thay đổi,
            // vòng lặp sẽ render lại và chờ tiếp.
        }
