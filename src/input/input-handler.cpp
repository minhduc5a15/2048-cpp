...
namespace tfe::input {
    ...
    void InputHandler::setRawMode(bool enable) {
        if (enable) {
            ...
            // Tắt echo (không hiện ký tự khi gõ) và canonical mode (đọc ngay lập tức)
    ...
    InputHandler::InputCommand InputHandler::readInput() {
        ...
        switch (c) {
        case 'w': return InputCommand::MoveUp;
        case 's': return InputCommand::MoveDown;
        case 'a': return InputCommand::MoveLeft;
        case 'd': return InputCommand::MoveRight;
